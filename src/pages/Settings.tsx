...
const Settings = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    age: "", // Custom field stored in Firestore
  ...
  // Handle form submission to update Firebase Auth and Firestore
  ...
  //     await updateDoc(userRef, { email, name, age, role });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email && email !== currentUser.email) {
        ...
        // Update email only after successful reauthentication
        await updateEmail(currentUser, email);
      }
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form action="#" onSubmit={handleSubmit}>
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row w-full">
